...
<a name="ul32851446111915"></a><a name="ul32851446111915"></a><ul id="ul32851446111915"><li>Uploading：表示正在上传</li><li>Ready：表示资源包已上传,</li><li>Failed：表示资源包上传失败。</li></ul>
</td>
</tr>
<tr id="row3141620111616"><td class="cellrowborder" valign="top" width="19.35%" headers="mcps1.2.3.1.1 "><p id="p414122018161"><a name="p414122018161"></a><a name="p414122018161"></a>文件名</p>
</td>
<td class="cellrowborder" valign="top" width="80.65%" headers="mcps1.2.3.1.2 "><p id="p1814102051615"><a name="p1814102051615"></a><a name="p1814102051615"></a>系统生成的程序包文件名。</p>
</td>
</tr>
