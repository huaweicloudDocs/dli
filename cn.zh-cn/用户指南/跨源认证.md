...
1.  创建需要访问的数据源。
    ...
    -   创建DCS数据源：在DCS服务中购买缓存实例，具体请参考《[分布式缓存服务用户指南](https://support.huaweicloud.com/usermanual-dcs/dcs-zh-ug-180315001.html)》。
    -   创建DDS数据源：在DDS服务中购买数据库实例，具体请参考《[文档数据库服务快速入门](https://support.huaweicloud.com/qs-dds/dds_02_0008.html)》。
