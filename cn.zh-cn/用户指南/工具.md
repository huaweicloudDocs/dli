...
SelectVariants可以将WGS测序流程计算出来的变异集进行进一步的过滤分类。 最常用的应用场景, 就是就使用该工具计算变异集中变异类型为SNP, 或者变异类型为INDEL的位点。

**图 1**  SelectVariants实例列表<a name="fig13997123214265"></a>  
...
单击[图1](#fig13997123214265)中![](figures/zh-cn_image_0130646465.png)，进入[图2](#fig1068084944916)页面。

**图 2**  创建SelectVariants实例<a name="fig1068084944916"></a>  
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p58542558105931"><a name="p58542558105931"></a><a name="p58542558105931"></a>选择文件夹或vcf文件。</p>
</td>
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p79531791050"><a name="p79531791050"></a><a name="p79531791050"></a>整个基因变异检测过程中，需要指定的参数。具体参数请参考《提交基因作业》&gt;《执行流程》中的<a href="执行流程.md#table56408147518">表1</a>。单击<a name="image4290175612508"></a><a name="image4290175612508"></a><span><img id="image4290175612508" src="figures/zh-cn_image_0129836338.png"></span>，可增加多个参数。</p>
</td>
...
**图 3**  SortVcf实例列表<a name="fig2097265303619"></a>  
...
单击[图3](#fig2097265303619)中![](figures/zh-cn_image_0133463262.png)，进入[图4](#fig1900104333713)页面。

**图 4**  创建SortVcf实例<a name="fig1900104333713"></a>  
...
<table><thead align="left"><tr id="row390554318379"><th class="cellrowborder" valign="top" width="16%" id="mcps1.2.4.1.1"><p id="p790624317372"><a name="p790624317372"></a><a name="p790624317372"></a>参数名称</p>
</th>
<th class="cellrowborder" valign="top" width="70%" id="mcps1.2.4.1.2"><p id="p190611433377"><a name="p190611433377"></a><a name="p190611433377"></a>描述</p>
</th>
...
<tbody><tr id="row10908104316379"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p99088435377"><a name="p99088435377"></a><a name="p99088435377"></a>输入路径</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p17909154318371"><a name="p17909154318371"></a><a name="p17909154318371"></a>指定OBS上vcf文件路径。</p>
</td>
...
<tr id="row159131243183719"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p491412438373"><a name="p491412438373"></a><a name="p491412438373"></a>输出路径</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p109152432376"><a name="p109152432376"></a><a name="p109152432376"></a>选择文件夹或vcf文件。</p>
</td>
...
<tr id="row2917543103711"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p149187431375"><a name="p149187431375"></a><a name="p149187431375"></a>参考基因</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p5918194311371"><a name="p5918194311371"></a><a name="p5918194311371"></a>基因行业内标准的基因库，目前支持hg19和hg38。</p>
</td>
...
<tr id="row692110439379"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p14921164373711"><a name="p14921164373711"></a><a name="p14921164373711"></a>删除原始VCF文件</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p092113432374"><a name="p092113432374"></a><a name="p092113432374"></a>是否删除原始VCF文件。</p>
</td>
...
<tr id="row69232043183713"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p159241443133719"><a name="p159241443133719"></a><a name="p159241443133719"></a>Intervals</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p1892619437372"><a name="p1892619437372"></a><a name="p1892619437372"></a>Intervals文件。</p>
</td>
...
**图 5**  Joint Calling实例列表<a name="fig25801913124417"></a>  
...
单击[图5](#fig25801913124417)中![](figures/zh-cn_image_0133463262.png)，进入[图6](#fig1263471319444)页面。

**图 6**  创建JointCalling实例<a name="fig1263471319444"></a>  
...
<table><thead align="left"><tr id="row1264716135447"><th class="cellrowborder" valign="top" width="16%" id="mcps1.2.4.1.1"><p id="p564741334411"><a name="p564741334411"></a><a name="p564741334411"></a>参数名称</p>
</th>
<th class="cellrowborder" valign="top" width="70%" id="mcps1.2.4.1.2"><p id="p1064971317446"><a name="p1064971317446"></a><a name="p1064971317446"></a>描述</p>
</th>
<th class="cellrowborder" valign="top" width="14.000000000000002%" id="mcps1.2.4.1.3"><p id="p46528139449"><a name="p46528139449"></a><a name="p46528139449"></a>示例</p>
</th>
</tr>
</thead>
<tbody><tr id="row18654113174419"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p126561913104414"><a name="p126561913104414"></a><a name="p126561913104414"></a>输入路径</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p5657013184417"><a name="p5657013184417"></a><a name="p5657013184417"></a>指定OBS上GVCF文件路径。</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.4.1.3 "><p id="p8658171316446"><a name="p8658171316446"></a><a name="p8658171316446"></a>-</p>
</td>
</tr>
<tr id="row16659191324412"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p966121310446"><a name="p966121310446"></a><a name="p966121310446"></a>输出路径</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p1066121344418"><a name="p1066121344418"></a><a name="p1066121344418"></a>选择文件夹或vcf文件。</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.4.1.3 "><p id="p266112135446"><a name="p266112135446"></a><a name="p266112135446"></a>-</p>
</td>
</tr>
<tr id="row966211138443"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p16631013104419"><a name="p16631013104419"></a><a name="p16631013104419"></a>参考基因</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p10665113144411"><a name="p10665113144411"></a><a name="p10665113144411"></a>基因行业内标准的基因库，目前支持hg19和hg38。</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.4.1.3 "><p id="p966720137444"><a name="p966720137444"></a><a name="p966720137444"></a>hg38</p>
</td>
</tr>
<tr id="row17667181344414"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p166701713164410"><a name="p166701713164410"></a><a name="p166701713164410"></a>参数设置</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p1267051374410"><a name="p1267051374410"></a><a name="p1267051374410"></a>整个基因变异检测过程中，需要指定的参数。具体参数请参考《提交基因作业》&gt;《执行流程》中的<a href="执行流程.md#table56408147518">表1</a>。单击<a name="image974516265521"></a><a name="image974516265521"></a><span><img id="image974516265521" src="figures/zh-cn_image_0133463265.png"></span>，可增加多个参数。</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.4.1.3 "><p id="p467191318444"><a name="p467191318444"></a><a name="p467191318444"></a>-</p>
</td>
</tr>
<tr id="row4673313184416"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.4.1.1 "><p id="p1267451334415"><a name="p1267451334415"></a><a name="p1267451334415"></a>Intervals</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.4.1.2 "><p id="p067501394418"><a name="p067501394418"></a><a name="p067501394418"></a>Intervals文件。</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.4.1.3 "><p id="p1167571317442"><a name="p1167571317442"></a><a name="p1167571317442"></a>-</p>
</td>
</tr>
</tbody>
</table>
