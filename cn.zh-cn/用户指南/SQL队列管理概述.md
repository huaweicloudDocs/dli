# SQL队列管理概述<a name="dli_01_0402"></a>
...
<p id="p54419740141957"><a name="p54419740141957"></a><a name="p54419740141957"></a>CUs是队列的计价单位。 1CUs= 4Core 16GMem 。不同规格的队列对应的计算能力不一样，规格越高计算能力越好。</p>
</td>
</tr>
