...
3.  在“创建程序包“对话框，参见[表1](#zh-cn_topic_0122016946_zh-cn_topic_0093946917_table19616613171536)设置相关参数。
    ...
    **表 1**  参数说明
    ...
    <div class="note" id="note1287585810107"><a name="note1287585810107"></a><a name="note1287585810107"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p168761558111014"><a name="p168761558111014"></a><a name="p168761558111014"></a>程序包需提前上传至OBS服务中保存。</p>
    </div></div>
    </td>
    </tr>
