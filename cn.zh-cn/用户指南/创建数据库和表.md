...
2.  在“创建表“页面，填写参数。
    ...
    -   当数据位置为OBS时，请参见[表2](#table34159998103738)和[表3](#table1913602718314)填写相关参数。
        ...
        **表 2**  通用参数说明
        ...
        <td class="cellrowborder" valign="top" width="75.48%" headers="mcps1.2.4.1.2 "><p id="p963515455220"><a name="p963515455220"></a><a name="p963515455220"></a>表的列名。列名应至少包含一个字母，并允许下划线（_），但不支持纯数字，以及数字与以字母B，K，M，G或D结尾的组合。</p>
