...
3.  选择“经典型跨源“页签，单击左上角的“创建”按钮。
    ...
    **表 2**  参数说明
    ...
    <a name="ul9527124812520"></a><a name="ul9527124812520"></a><ul id="ul9527124812520"><li>表格存储服务 CloudTable：ZK链接地址或者OpenTSDB链接地址。</li><li>MapReduce服务 OpenTSDB：OpenTSDB所在节点的IP：OpenTSDB服务对外端口。<p id="p16682129182918"><a name="p16682129182918"></a><a name="p16682129182918"></a>MRS OpenTSDB IP信息和端口信息获取方式：</p>
    ...
    </li><li>数据仓库服务 DWS：内网IP:端口。<div class="note" id="note7710170174516"><a name="note7710170174516"></a><a name="note7710170174516"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p147221034514"><a name="p147221034514"></a><a name="p147221034514"></a>DWS服务集群提供2个内网IP，创建跨源连接时填写其中任意一个内网IP即可。</p>
    </div></div>
    </li><li>云数据库（关系型数据库） RDS：内网地址:数据库端口。</li><li>云搜索服务 CSS：内网地址:端口。<div class="note" id="note1086110194619"><a name="note1086110194619"></a><a name="note1086110194619"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p28600154610"><a name="p28600154610"></a><a name="p28600154610"></a>如果CSS服务集群存在多个内网IP，创建跨源连接时填写其中任意一个内网IP即可。</p>
    </div></div>
    </li></ul>
    </td>
    </tr>
...
在“经典型跨源“页面，选中一条连接，单击该连接对应的![](figures/icon-展开-1.png)，可查看该条连接的详细信息。
