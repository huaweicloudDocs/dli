...
**图 1**  Spark作业编辑器页面<a name="fig14932185183913"></a>  
...
<td class="cellrowborder" valign="top" width="75.94059405940594%" headers="mcps1.2.4.1.3 "><p id="p11658446151"><a name="p11658446151"></a><a name="p11658446151"></a>作业编辑窗口可设置Spark作业相关参数：</p>
<a name="ul4888636169"></a><a name="ul4888636169"></a><ul id="ul4888636169"><li>选择运行队列</li><li>选择程序包</li><li>高级配置<a name="ul20602192912502"></a><a name="ul20602192912502"></a><ul id="ul20602192912502"><li>计算资源规格</li><li>选择依赖资源</li></ul>
</li></ul>
</td>
</tr>
<tr id="row011171014312"><td class="cellrowborder" valign="top" width="7.920792079207921%" headers="mcps1.2.4.1.1 "><p id="p1493120356172"><a name="p1493120356172"></a><a name="p1493120356172"></a>4</p>
</td>
<td class="cellrowborder" valign="top" width="16.13861386138614%" headers="mcps1.2.4.1.2 "><p id="p1893203561719"><a name="p1893203561719"></a><a name="p1893203561719"></a>购买计算资源</p>
</td>
<td class="cellrowborder" valign="top" width="75.94059405940594%" headers="mcps1.2.4.1.3 "><p id="p4932153541713"><a name="p4932153541713"></a><a name="p4932153541713"></a>根据需要购买队列。可选择“包年/包月”或“按需计费”。计费详情请参考<a href="https://support.huaweicloud.com/price-dli/dli_06_0000.html" target="_blank" rel="noopener noreferrer">《数据湖探索价格说明》</a>。</p>
</td>
</tr>
</tbody>
</table>
...
-   选择运行队列：具体参数请参考[表3](#zh-cn_topic_0115200017_table18913103220552)。
-   选择程序包：具体参数请参考[表4](#table161519411416)。
-   计算资源规格：具体参数请参考[表5](#table1680231613596)。
-   选择依赖资源：具体参数请参考[表6](#table1386622213325)。
...
1.  在Spark作业编辑窗口中，输入相关参数，具体请参考关于[图3](#zh-cn_topic_0115200017_fig12259471592)的说明。
