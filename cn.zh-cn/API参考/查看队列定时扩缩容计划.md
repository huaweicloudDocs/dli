...
-   请求样例：
    -   **描述:**
        ...
        查看项目ID为48cc2c48765f481480c7db940d6409d1队列名称为queue1的扩缩容计划。

    -   **示例URL:**

        GET https://\{endpoint\}/v1/48cc2c48765f481480c7db940d6409d1/queues/queue1/plans
...
<tbody><tr id="zh-cn_topic_0207595520_row1047920308387"><td class="cellrowborder" valign="top" width="14.299999999999999%" headers="mcps1.2.3.1.1 "><p id="p3704248105917"><a name="p3704248105917"></a><a name="p3704248105917"></a>DLI.0008</p>
</td>
