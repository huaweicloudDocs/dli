# 单个删除队列定时扩缩容计划<a name="dli_02_0294"></a>
...
-   参数说明
    ...
    **表 1**  URI参数
    ...
    <td class="cellrowborder" valign="top" width="73.7%" headers="mcps1.2.4.1.3 "><p id="p4680152912011"><a name="p4680152912011"></a><a name="p4680152912011"></a>待删除的队列扩缩容计划的ID。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   请求样例：
    -   **描述:**
        ...
        删除项目ID为48cc2c48765f481480c7db940d6409d1下名称为queue1的队列的ID为3的扩缩容计划。

    -   **示例URL:**

        DELETE https://\{endpoint\}/v1/48cc2c48765f481480c7db940d6409d1/queues/queue1/plans/3
