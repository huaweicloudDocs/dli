...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DLI&api=UploadFiles)中调试该接口。
...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_row61411666"><th class="cellrowborder" valign="top" width="11.71882811718828%" id="mcps1.2.5.1.1"><p id="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_a420a62a594f9410eaea229ffc8037a61"><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_a420a62a594f9410eaea229ffc8037a61"></a><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_a420a62a594f9410eaea229ffc8037a61"></a>参数名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="12.218778122187782%" id="mcps1.2.5.1.2"><p id="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p873025824211"><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p873025824211"></a><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p873025824211"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="10.66893310668933%" id="mcps1.2.5.1.3"><p id="p20215346175716"><a name="p20215346175716"></a><a name="p20215346175716"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="65.39346065393461%" id="mcps1.2.5.1.4"><p id="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_a692d3cd97b464aed90ba6d841900a4a5"><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_a692d3cd97b464aed90ba6d841900a4a5"></a><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_a692d3cd97b464aed90ba6d841900a4a5"></a>说明</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_row48589216"><td class="cellrowborder" valign="top" width="11.71882811718828%" headers="mcps1.2.5.1.1 "><p id="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p43412436"><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p43412436"></a><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p43412436"></a>project_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.218778122187782%" headers="mcps1.2.5.1.2 "><p id="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p26746391"><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p26746391"></a><a name="zh-cn_topic_0142813187_zh-cn_topic_0103345073_zh-cn_topic_0102902533_zh-cn_topic_0069077803_p26746391"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="10.66893310668933%" headers="mcps1.2.5.1.3 "><p id="p821644612572"><a name="p821644612572"></a><a name="p821644612572"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="65.39346065393461%" headers="mcps1.2.5.1.4 "><p id="p1310472724012"><a name="p1310472724012"></a><a name="p1310472724012"></a>项目编号，用于资源隔离。获取方式请参考<a href="获取项目ID.md">获取项目ID</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
<table><thead align="left"><tr id="zh-cn_topic_0142813183_row852411395818"><th class="cellrowborder" valign="top" width="17%" id="mcps1.2.5.1.1"><p id="zh-cn_topic_0142813183_p452513399816"><a name="zh-cn_topic_0142813183_p452513399816"></a><a name="zh-cn_topic_0142813183_p452513399816"></a>参数名称</p>
</th>
<th class="cellrowborder" valign="top" width="10.68%" id="mcps1.2.5.1.2"><p id="p7267177395"><a name="p7267177395"></a><a name="p7267177395"></a>是否必选</p>
</th>
...
<tbody><tr id="zh-cn_topic_0142813183_row353014398813"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="zh-cn_topic_0142813183_p0558193912915"><a name="zh-cn_topic_0142813183_p0558193912915"></a><a name="zh-cn_topic_0142813183_p0558193912915"></a>group_name</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p8267117153915"><a name="p8267117153915"></a><a name="p8267117153915"></a>否</p>
</td>
...
<tr id="zh-cn_topic_0142813183_row253515391481"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="zh-cn_topic_0142813183_p13558123916911"><a name="zh-cn_topic_0142813183_p13558123916911"></a><a name="zh-cn_topic_0142813183_p13558123916911"></a>status</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p19267157183916"><a name="p19267157183916"></a><a name="p19267157183916"></a>否</p>
</td>
...
<tr id="zh-cn_topic_0142813183_row56285413914"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="zh-cn_topic_0142813183_p135592391891"><a name="zh-cn_topic_0142813183_p135592391891"></a><a name="zh-cn_topic_0142813183_p135592391891"></a>resources</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p172674718392"><a name="p172674718392"></a><a name="p172674718392"></a>否</p>
</td>
...
<tr id="row15250103117368"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="p17251143113617"><a name="p17251143113617"></a><a name="p17251143113617"></a>details</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p10251113133615"><a name="p10251113133615"></a><a name="p10251113133615"></a>否</p>
</td>
...
<tr id="zh-cn_topic_0142813183_row53798101497"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="zh-cn_topic_0142813183_p15559139391"><a name="zh-cn_topic_0142813183_p15559139391"></a><a name="zh-cn_topic_0142813183_p15559139391"></a>create_time</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p13267172397"><a name="p13267172397"></a><a name="p13267172397"></a>否</p>
</td>
...
<tr id="zh-cn_topic_0142813183_row1538239489"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="zh-cn_topic_0142813183_p65593391794"><a name="zh-cn_topic_0142813183_p65593391794"></a><a name="zh-cn_topic_0142813183_p65593391794"></a>update_time</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p926777153919"><a name="p926777153919"></a><a name="p926777153919"></a>否</p>
</td>
...
<tr id="row7148120153319"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="p1047414300516"><a name="p1047414300516"></a><a name="p1047414300516"></a>is_async</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p2047453014513"><a name="p2047453014513"></a><a name="p2047453014513"></a>否</p>
</td>
...
<tr id="row55561943127"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="p1291831513129"><a name="p1291831513129"></a><a name="p1291831513129"></a>owner</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p10290923101217"><a name="p10290923101217"></a><a name="p10290923101217"></a>否</p>
</td>
...
<tr id="row15581123710341"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="p1651043015362"><a name="p1651043015362"></a><a name="p1651043015362"></a>description</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p13510123023619"><a name="p13510123023619"></a><a name="p13510123023619"></a>否</p>
</td>
...
<tr id="row18582237193411"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="p1772416436343"><a name="p1772416436343"></a><a name="p1772416436343"></a>module_name</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p572419433348"><a name="p572419433348"></a><a name="p572419433348"></a>否</p>
</td>
...
<tr id="row11583837103413"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.5.1.1 "><p id="p4724204393413"><a name="p4724204393413"></a><a name="p4724204393413"></a>module_type</p>
</td>
<td class="cellrowborder" valign="top" width="10.68%" headers="mcps1.2.5.1.2 "><p id="p35291456144014"><a name="p35291456144014"></a><a name="p35291456144014"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="54.67999999999999%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0103345070_p1560611254223"><a name="zh-cn_topic_0103345070_p1560611254223"></a><a name="zh-cn_topic_0103345070_p1560611254223"></a>资源类型，此处为file。</p>
</td>
</tr>
...
<tr id="row884816491759"><td class="cellrowborder" valign="top" width="18.08%" headers="mcps1.2.5.1.1 "><p id="p179119526411"><a name="p179119526411"></a><a name="p179119526411"></a>is_async</p>
</td>
...
-   请求样例：
    ...
    {
        "paths": [
            "https: //test.obs.huawei.com/test_dli.jar",
