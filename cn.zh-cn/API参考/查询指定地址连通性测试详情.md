...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DLI&api=ShowNodeConnectivity)中调试该接口。
...
-   参数说明
    ...
    **表 1**  URI参数
    ...
    <th class="cellrowborder" valign="top" width="13.58%" id="mcps1.2.5.1.3"><p id="p19878136202716"><a name="p19878136202716"></a><a name="p19878136202716"></a>参数类型</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="13.58%" headers="mcps1.2.5.1.3 "><p id="p138787362275"><a name="p138787362275"></a><a name="p138787362275"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="13.58%" headers="mcps1.2.5.1.3 "><p id="p587843682712"><a name="p587843682712"></a><a name="p587843682712"></a>String</p>
    </td>
    ...
    <tr id="row1567913291203"><td class="cellrowborder" valign="top" width="16.48%" headers="mcps1.2.5.1.1 "><p id="p9452135532013"><a name="p9452135532013"></a><a name="p9452135532013"></a>task_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.24%" headers="mcps1.2.5.1.2 "><p id="p145216550201"><a name="p145216550201"></a><a name="p145216550201"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.58%" headers="mcps1.2.5.1.3 "><p id="p1878536152717"><a name="p1878536152717"></a><a name="p1878536152717"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.699999999999996%" headers="mcps1.2.5.1.4 "><p id="p4680152912011"><a name="p4680152912011"></a><a name="p4680152912011"></a>任务ID。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
<tr id="row4217146142917"><td class="cellrowborder" valign="top" width="30%" headers="mcps1.2.3.1.1 "><p id="p121764615295"><a name="p121764615295"></a><a name="p121764615295"></a>500</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.3.1.2 "><p id="p2218164610295"><a name="p2218164610295"></a><a name="p2218164610295"></a>内部服务器错误。</p>
</td>
</tr>
</tbody>
</table>
