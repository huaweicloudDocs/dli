...
-   参数说明
    ...
    **表 1**  URI 参数
    ...
    <td class="cellrowborder" valign="top" width="69.94%" headers="mcps1.2.4.1.3 "><p id="p2192055111118"><a name="p2192055111118"></a><a name="p2192055111118"></a>是否强制删除数据库，范围: [true|false]。默认值为：false。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="69.94%" headers="mcps1.2.4.1.3 "><p id="p18390918127"><a name="p18390918127"></a><a name="p18390918127"></a>是否异步方式删除数据库，范围: [true|false]。默认值为：false。</p>
    </td>
    </tr>
    </tbody>
    </table>
