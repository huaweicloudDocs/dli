...
-   响应参数
    ...
    **表 2**  响应参数说明
    ...
    <th class="cellrowborder" valign="top" width="12.36%" id="mcps1.2.5.1.3"><p id="zh-cn_topic_0103343296_zh-cn_topic_0102902518_a59685f4525af4d82a623288ff8ccb0f4"><a name="zh-cn_topic_0103343296_zh-cn_topic_0102902518_a59685f4525af4d82a623288ff8ccb0f4"></a><a name="zh-cn_topic_0103343296_zh-cn_topic_0102902518_a59685f4525af4d82a623288ff8ccb0f4"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="52.64%" id="mcps1.2.5.1.4"><p id="zh-cn_topic_0103343296_zh-cn_topic_0102902518_zh-cn_topic_0069077927_p632718127368"><a name="zh-cn_topic_0103343296_zh-cn_topic_0102902518_zh-cn_topic_0069077927_p632718127368"></a><a name="zh-cn_topic_0103343296_zh-cn_topic_0102902518_zh-cn_topic_0069077927_p632718127368"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="12.36%" headers="mcps1.2.5.1.3 "><p id="p17979547162111"><a name="p17979547162111"></a><a name="p17979547162111"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.64%" headers="mcps1.2.5.1.4 "><p id="p122858914214"><a name="p122858914214"></a><a name="p122858914214"></a>创建集群的时间。是单位为“毫秒”的时间戳。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="12.36%" headers="mcps1.2.5.1.3 "><p id="p928516920211"><a name="p928516920211"></a><a name="p928516920211"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.64%" headers="mcps1.2.5.1.4 "><p id="p728514912112"><a name="p728514912112"></a><a name="p728514912112"></a>集群的描述信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="12.36%" headers="mcps1.2.5.1.3 "><p id="p162858982116"><a name="p162858982116"></a><a name="p162858982116"></a>Integer</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.64%" headers="mcps1.2.5.1.4 "><p id="p18285594212"><a name="p18285594212"></a><a name="p18285594212"></a>与集群绑定的计算单元个数。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="12.36%" headers="mcps1.2.5.1.3 "><p id="p202867952112"><a name="p202867952112"></a><a name="p202867952112"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.64%" headers="mcps1.2.5.1.4 "><p id="p132867912118"><a name="p132867912118"></a><a name="p132867912118"></a>创建集群的用户。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="12.36%" headers="mcps1.2.5.1.3 "><p id="p172869952119"><a name="p172869952119"></a><a name="p172869952119"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.64%" headers="mcps1.2.5.1.4 "><p id="p8286592216"><a name="p8286592216"></a><a name="p8286592216"></a>集群名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="12.36%" headers="mcps1.2.5.1.3 "><p id="p67691301565"><a name="p67691301565"></a><a name="p67691301565"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.64%" headers="mcps1.2.5.1.4 "><p id="p177691630195614"><a name="p177691630195614"></a><a name="p177691630195614"></a>具体集群状态信息可参见<a href="#zh-cn_topic_0103345069_table399612265336">表3</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p87428474417"><a name="p87428474417"></a><a name="p87428474417"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.36%" headers="mcps1.2.5.1.3 "><p id="p0743247194113"><a name="p0743247194113"></a><a name="p0743247194113"></a>Integer</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.64%" headers="mcps1.2.5.1.4 "><p id="p87430471414"><a name="p87430471414"></a><a name="p87430471414"></a>集群类型。</p>
    ...
    **表 3**  集群状态说明
    ...
    <td class="cellrowborder" valign="top" width="82.42%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0103345069_p257132215341"><a name="zh-cn_topic_0103345069_p257132215341"></a><a name="zh-cn_topic_0103345069_p257132215341"></a>由于长时间未使用，集群当前处于挂起状态，可通过<a href="获取指定集群信息（废弃）.md">获取指定集群信息（废弃）</a>、<a href="创建会话（废弃）.md">创建会话（废弃）</a>和<a href="创建批处理作业.md">创建批处理作业</a>接口，重新激活集群。</p>
    </td>
    </tr>
