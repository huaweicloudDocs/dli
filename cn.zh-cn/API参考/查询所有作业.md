...
-   URI格式：
    ...
    GET/v1.0/\{project\_id\}/jobs?page-size=_size_&current-page=_page\_number_&start=_start\_time_&end=_end\_time_&job-type=QUERY&queue\_name=test&order=duration\_desc
...
<th class="cellrowborder" valign="top" width="9.217821782178218%" id="mcps1.2.5.1.3"><p id="p523251842315"><a name="p523251842315"></a><a name="p523251842315"></a>参数类型</p>
</th>
<th class="cellrowborder" valign="top" width="61.24752475247524%" id="mcps1.2.5.1.4"><p id="p13233131819235"><a name="p13233131819235"></a><a name="p13233131819235"></a>说明</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p923551818236"><a name="p923551818236"></a><a name="p923551818236"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p3235618162318"><a name="p3235618162318"></a><a name="p3235618162318"></a>作业ID。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p02351918102319"><a name="p02351918102319"></a><a name="p02351918102319"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p22351187234"><a name="p22351187234"></a><a name="p22351187234"></a>作业类型。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p162351318122316"><a name="p162351318122316"></a><a name="p162351318122316"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p132351318152311"><a name="p132351318152311"></a><a name="p132351318152311"></a>作业提交的队列。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p2236121812232"><a name="p2236121812232"></a><a name="p2236121812232"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p192362018142313"><a name="p192362018142313"></a><a name="p192362018142313"></a>提交作业的用户。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p923691852314"><a name="p923691852314"></a><a name="p923691852314"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p10236191862311"><a name="p10236191862311"></a><a name="p10236191862311"></a>作业开始的时间。是单位为“毫秒”的时间戳。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p12236918162310"><a name="p12236918162310"></a><a name="p12236918162310"></a>Long</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p923731815236"><a name="p923731815236"></a><a name="p923731815236"></a>作业运行时长，单位毫秒。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p12237181814231"><a name="p12237181814231"></a><a name="p12237181814231"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p10237141862310"><a name="p10237141862310"></a><a name="p10237141862310"></a>此作业的当前状态，包含提交（LAUNCHING）、运行中（RUNNING）、完成（FINISHED）、失败（FAILED）、取消（CANCELLED）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p1238151818233"><a name="p1238151818233"></a><a name="p1238151818233"></a>Long</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p7238171852316"><a name="p7238171852316"></a><a name="p7238171852316"></a>Insert作业执行过程中扫描的记录条数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p22381418132313"><a name="p22381418132313"></a><a name="p22381418132313"></a>Long</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p1223891822314"><a name="p1223891822314"></a><a name="p1223891822314"></a>Insert作业执行过程中扫描到的错误记录数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p9239151892312"><a name="p9239151892312"></a><a name="p9239151892312"></a>Long</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p1823951882316"><a name="p1823951882316"></a><a name="p1823951882316"></a>作业执行过程中扫描文件的大小。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p15239131822312"><a name="p15239131822312"></a><a name="p15239131822312"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p5239151892319"><a name="p5239151892319"></a><a name="p5239151892319"></a>当前作业返回的结果总条数或insert作业插入的总条数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p1724017181237"><a name="p1724017181237"></a><a name="p1724017181237"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p20240518122315"><a name="p20240518122315"></a><a name="p20240518122315"></a>记录其操作的表所在的数据库名称。类型为Import和Export作业才有<span class="parmname" id="parmname13240218172314"><a name="parmname13240218172314"></a><a name="parmname13240218172314"></a>“database_name”</span>属性。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p182409185239"><a name="p182409185239"></a><a name="p182409185239"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p12411181234"><a name="p12411181234"></a><a name="p12411181234"></a>记录其操作的表名称。类型为Import和Export作业才有<span class="parmname" id="parmname1224131820231"><a name="parmname1224131820231"></a><a name="parmname1224131820231"></a>“table_name”</span>属性。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p82411818142314"><a name="p82411818142314"></a><a name="p82411818142314"></a>boolean</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p192411518192318"><a name="p192411518192318"></a><a name="p192411518192318"></a>Import类型的作业，记录其导入的数据是否包括列名。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p024261817231"><a name="p024261817231"></a><a name="p024261817231"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p8242318162314"><a name="p8242318162314"></a><a name="p8242318162314"></a>SQL查询的相关列信息的Json字符串。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.217821782178218%" headers="mcps1.2.5.1.3 "><p id="p1924351832310"><a name="p1924351832310"></a><a name="p1924351832310"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="61.24752475247524%" headers="mcps1.2.5.1.4 "><p id="p162431318102319"><a name="p162431318102319"></a><a name="p162431318102319"></a>作业执行的SQL语句。</p>
</td>
</tr>
</tbody>
</table>
