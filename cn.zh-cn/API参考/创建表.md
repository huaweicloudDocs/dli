...
<td class="cellrowborder" valign="top" width="69.3069306930693%" headers="mcps1.2.5.1.4 "><p id="p182832663914"><a name="p182832663914"></a><a name="p182832663914"></a>新增OBS表数据的类型，目前支持：Parquet、ORC、CSV、JSON和Carbon格式。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="78%" headers="mcps1.2.4.1.3 "><p id="p15380173521417"><a name="p15380173521417"></a><a name="p15380173521417"></a>执行请求是否成功。<span class="parmvalue" id="parmvalue10405423161014"><a name="parmvalue10405423161014"></a><a name="parmvalue10405423161014"></a><b>true</b></span>表示请求执行成功。</p>
</td>
</tr>
