...
-   响应参数
    ...
    **表 2**  响应参数说明
    ...
    <td class="cellrowborder" valign="top" width="49%" headers="mcps1.2.5.1.4 "><p id="p177691630195614"><a name="p177691630195614"></a><a name="p177691630195614"></a>具体集群状态信息可参见<a href="#dli_02_0112__zh-cn_topic_0103345069_table399612265336">表3</a></p>
    </td>
    </tr>
    </tbody>
    </table>
