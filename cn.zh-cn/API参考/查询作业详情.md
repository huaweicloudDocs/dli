...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <td class="cellrowborder" valign="top" width="60.333966603339675%" headers="mcps1.2.5.1.4 "><p id="p107582414296"><a name="p107582414296"></a><a name="p107582414296"></a>作业ID。</p>
    </td>
    </tr>
    </tbody>
    </table>
