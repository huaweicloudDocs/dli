...
-   参数说明
    ...
    **表 1**  URI参数
    ...
    <td class="cellrowborder" valign="top" width="79.7979797979798%" headers="mcps1.2.4.1.3 "><p id="p437093219407"><a name="p437093219407"></a><a name="p437093219407"></a>项目编号，用于资源隔离。获取方式请参考<a href="获取项目编号.md">获取项目编号</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
